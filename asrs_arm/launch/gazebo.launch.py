...
def generate_launch_description():
    ...
    env_variable = SetEnvironmentVariable("GAZEBO_MODEL_PATH", os.path.join(get_package_share_directory("asrs_arm"), "share"))
    ...
    spawn_robot = Node(
        ...
        arguments=["-entity", "asrs_arm", "-topic", "robot_description"]
    )
